...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE lunch SET name='$name', description='$description', mrp='$mrp', image='$fileName' WHERE id=$id";

    if (mysqli_query($conn, $sql)) {
        header("Location: editproductL.php");
        exit();
    } else {
...
<body>
    <div class="container border border-1 border-dark my-5 p-3">
        <h1 class="text-center">Edit Lunch</h1>
        <form action="editlunch.php" method="post" enctype="multipart/form-data">
