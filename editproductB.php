...
<div class="container mt-4">
    <h1 class="text-center">Breakfast Items</h1>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td>{$row['mrp']}</td>";
                echo "<td><img src='breakfast/{$row['image']}'  style='max-width: 100px; max-height: 100px;'></td>";
                echo "<td><a href='editbreakfast.php?id={$row['Id']}'class='btn btn-lg btn-primary'>Edit</a> | <a href='deletebreakfast.php?id={$row['Id']}' class='btn btn-lg btn-danger'>Delete</a></td>";
                echo "</tr>";
            }
            ?>
        </tbody>
